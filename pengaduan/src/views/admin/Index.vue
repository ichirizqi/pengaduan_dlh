        ...
        <div class="flex justify-center items-center">
            <div class="bg-white md:w-2/5 md:mt-7 mt-10 border-2 border-gray-100 px-10 rounded-lg">
                ...
                <div>
                    ...
                    <form @submit.prevent="login">
                        <div>
                            <div class="mb-2">
                                ...
                                <p class="font-worksans text-center">Silahkan Masuk Sebagai Admin</p>
                            </div>
                            <div v-if="loginFailed" class="text-center bg-red-300 p-2 mt-2 rounded-md">
                                Email atau Password Anda salah.
                            </div>
                            <div class="mx-4 mt-5">
                                <p class="font-poppins text-gray-800 font-medium text-sm">Email</p>
                                <input type="email" class="form-control mt-3 shadow appearance-none bg-white border rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    placeholder="Masukkan Email Anda" v-model="user.email" required>
                            </div>
                            <div class="mx-4 mt-5">
                    ...
                    <div class="ml-16 my-5">
                        <a class="hover:text-green-400" href="/dinas">Klik Untuk Masuk Sebagai Pegawai Dinas</a>
                    </div>
                </div>
