                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-black">Form Edit Akun Admin</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form @submit.prevent="update">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="flex flex-row">
                                                <img :src="path + '/admin/'+ admin.foto" alt="Foto" style="width:150px">
                                                <div class="input-group ml-5 mt-4">
                                                    <div class="custom-file mb-5 ">
                                                        <input type="file" class="form-control" id="file" ref="photo" name="photo" @change='uploadPhoto'>
...
export default {
    ...
    methods: {
        ...
        axios.post(`http://localhost:8000/api/admin/editadmin/${this.$route.params.id}`, 
            // Code Baru
            formData, {
            headers: {
    ...
    beforeMount(){ 
          ...
          axios.get(`http://localhost:8000/api/admin/detailadmin/${this.$route.params.id}`)
          .then(response => { 
              this.form.name = response.data.data.name;
              this.form.email = response.data.data.email;
                // this.form.photo = response.data.data.foto;
