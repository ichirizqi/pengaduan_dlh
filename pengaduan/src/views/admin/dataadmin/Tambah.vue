                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/admin/akun-admin">
                        <div class="bg-green-200 md:w-48 md:h-10 px-2 py-2 rounded-sm text-green-700 -mb-4 -mt-2">
                            <i class="fas fa-user "  style="color:#127456"></i>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                 <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Akun Admin</h1>

                    <div class="row mt-5">
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-black">Form Tambah Akun Admin</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form @submit.prevent="SubmitPhoto" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukkan nama" required v-model="form.name"
                                            id="name" ref="name">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email<span style="color:red">*</span></label>
                                            <input type="email" class="form-control" placeholder="Masukkan email" required v-model="form.email"
                                            id="email" ref="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Password<span style="color:red">*</span></label>
                                            <input type="password" class="form-control" placeholder="Masukkan password" required v-model="form.password"
                                            id="password" ref="password">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Peran Pengguna<span style="color:red">*</span></label>
                                            <input type="id_peran" class="form-control" value="Admin" readonly>
                                            <input type="id_peran" class="form-control" placeholder="Admin" v-model="form.id_peran" hidden
                                            id="id_peran" ref="id_peran">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <a href="/admin/akun-admin" class="btn btn-default border-secondary pull-right ml-2 hover:bg-gray-200 hover:text-white">Kembali</a>
...
export default {
    ...
    methods: {
        ...
        getPhoto(){
        let photo = (this.form.photo.length > 100) ? this.form.photo : "admin/"+ this.form.photo;
        return photo;
        },
        //Insert Photo
        SubmitPhoto(){
        ...
        formData.append('id_peran', this.form.id_peran);
        ...
        axios.post(` http://localhost:8000/api/admin/register`, 
            ...
            .then(()=>{
                ...
                this.$router.push({name: 'admin-akun-admin'});  
            })
            .catch(()=>{
