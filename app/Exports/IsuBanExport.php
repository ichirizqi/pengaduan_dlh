...
class IsuBanExport implements FromQuery, ShouldAutoSize, WithHeadings, WithEvents, WithCustomStartCell
{
    use Exportable;
    
    public function __construct(int $year,  $status)
    {
        $this->year = $year;
        $this->status = $status;
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getCell('A1')->setValue('Laporan Tahunan Data Pengaduan Tidak Diverifikasi');
